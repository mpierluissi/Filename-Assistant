...
_recipes_pil_prescript(['FitsStubImagePlugin', 'XpmImagePlugin', 'XVThumbImagePlugin', 'PpmImagePlugin', 'PcdImagePlugin', 'Hdf5StubImagePlugin', 'FliImagePlugin', 'CurImagePlugin', 'FtexImagePlugin', 'MspImagePlugin', 'DdsImagePlugin', 'FpxImagePlugin', 'GifImagePlugin', 'GbrImagePlugin', 'PixarImagePlugin', 'BufrStubImagePlugin', 'EpsImagePlugin', 'PdfImagePlugin', 'WebPImagePlugin', 'Jpeg2KImagePlugin', 'MicImagePlugin', 'DcxImagePlugin', 'JpegImagePlugin', 'PcxImagePlugin', 'SunImagePlugin', 'ImImagePlugin', 'BmpImagePlugin', 'IcnsImagePlugin', 'XbmImagePlugin', 'WmfImagePlugin', 'PsdImagePlugin', 'MpoImagePlugin', 'GribStubImagePlugin', 'TiffImagePlugin', 'MpegImagePlugin', 'PngImagePlugin', 'McIdasImagePlugin', 'IcoImagePlugin', 'PalmImagePlugin', 'IptcImagePlugin', 'SpiderImagePlugin', 'ImtImagePlugin', 'FitsImagePlugin', 'BlpImagePlugin', 'TgaImagePlugin', 'SgiImagePlugin'])
...
DEFAULT_SCRIPT='Filename Assistant.py'
SCRIPT_MAP={}
_run()
