# UCS FILENAME ASSISTANT v3.8.8.2
    ...
    def onClose(self):
        ...
        for item in curWindowGeometry:
            if item == '+':
                break
            posLoc += 1
        updateConfigVar('Window Settings', 'windowposition', '440x650' + curWindowGeometry[posLoc:])
...
class batchRenameWindow(tk.Frame):
    def __init__(self, master):
        ...
        inFileListbox.register_drop_target('*')
        inFileListbox.bind('<<Drop>>', addToInFileListbox)
